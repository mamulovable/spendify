...
/**
 * DealFuel LTD Redemption Landing Page
 *
 * This page serves as the landing page for DealFuel customers to:
 * - Learn about SpendlyAI features through interactive visualizations
 * - Understand LTD benefits
 * - Register for an account
 * - Redeem their DealFuel codes
 *
 * Requirements:
 * - 1.1: Display dedicated DealFuel LTD landing page at /redeem
 * - 1.5: Maintain consistent branding with main application
 * - 8.1: Fully responsive layout for all device sizes
 */
const DealFuelRedeem = () => {
  ...
  useEffect(() => {
    document.title = "DealFuel - Lifetime Deal";
    if (location.hash) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-primary text-primary-foreground py-2 px-4 text-center text-sm">
        <Container>
          <div className="flex items-center justify-center gap-2">
            ...
            <span>Exclusive DealFuel Lifetime Deal - Limited Time Offer</span>
          </div>
        </Container>
      </div>
      ...
      <div className="bg-muted/30 py-2 border-b">
        <Container>
          <nav className="flex items-center text-sm">
            ...
            <span className="font-medium">DealFuel Lifetime Deal</span>
          </nav>
        </Container>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium animate-pulse">
                ...
                DealFuel Exclusive Lifetime Deal
              </div>
            ...
            <div className="relative">
              ...
              <div className="hidden md:flex absolute -bottom-4 -right-4 bg-background shadow-lg rounded-lg px-3 py-2 border border-border">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">DealFuel Exclusive</span>
                </div>
              </div>
      ...
      <section id="benefits" className="py-16">
        <Container>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Your DealFuel Lifetime Deal Benefits</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {[
              ...
              {
                title: "Exclusive DealFuel Bonuses",
                description: "Special perks and bonuses available only to DealFuel LTD customers.",
                icon: "gift",
          ...
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-6 border border-primary/20 text-center">
            ...
            <p className="text-muted-foreground mb-4 max-w-2xl mx-auto">
              DealFuel deals are available for a limited time only. Lock in your lifetime access to SpendlyAI today and never worry about subscription fees again.
            </p>
            <Button
              size="lg"
        ...
        <Container>
          <div className="max-w-md mx-auto bg-background rounded-lg p-8 shadow-sm border border-border/50">
            ...
            <p className="text-center text-muted-foreground mb-6">
              Create your SpendlyAI account to redeem your DealFuel code.
            </p>
            <RegistrationForm
      ...
      <section id="signin" className="py-16">
        <Container>
          <div className="max-w-md mx-auto bg-background rounded-lg p-8 shadow-sm border border-border/50">
            ...
            <p className="text-center text-muted-foreground mb-6">
              Sign in to your existing account to redeem your DealFuel code.
            </p>
            <SignInForm
              onSuccess={handleAuthSuccess}
          ...
          <div className="max-w-2xl mx-auto bg-background rounded-lg p-8 shadow-sm border border-border/50">
            {!user && (
              <div className="text-center">
                <h2 className="text-2xl font-bold mb-6">Get Started with Your DealFuel Deal</h2>
                <p className="text-muted-foreground mb-6">
                  You need to be signed in to redeem your DealFuel code.
                </p>
            ...
            {user && isDealifyUser && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                ...
                <h3 className="text-xl font-medium text-green-800 mb-2">DealFuel Code Already Redeemed</h3>
                <p className="text-green-700 mb-4">
                  Your account is already activated with an DealFuel lifetime plan.
                </p>
                <Button
              ...
              <>
                ...
                {currentStep === 'auth' && (
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Select your DealFuel LTD plan to get started.
                    </p>
                    <Button
      ...
      <section id="faq" className="py-16 bg-muted/50">
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Common questions about the DealFuel deal and redemption process.
            </p>
          </div>
