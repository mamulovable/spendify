      ...
      <Tabs defaultValue="system">
        ...
        <TabsContent value="system" className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <ExportDataButton data={userGrowth} dataType="userGrowth" />
          </div>
        ...
        <TabsContent value="users" className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium">User Growth Analysis</h3>
            <ExportDataButton data={userGrowth} dataType="userGrowth" disabled={loading} />
          </div>
          <Card>
            <CardHeader>
        ...
        <TabsContent value="retention" className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <ExportDataButton data={retention} dataType="retention" disabled={loading} />
          </div>
          <Card>
            <CardHeader>
        ...
        <TabsContent value="financial" className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <ExportDataButton data={revenue} dataType="revenue" disabled={loading} />
          </div>
          <Card>
            <CardHeader>
        ...
        <TabsContent value="performance" className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <ExportDataButton data={documentProcessing} dataType="documentProcessing" disabled={loading} />
          </div>
          <Card>
            <CardHeader>
