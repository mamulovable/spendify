...
const features = [
  {
    ...
    icon: ShieldAlert,
    visual: <ImagePlaceholder src="https://github.com/mamulovable/spendify/blob/mamulovable-patch-1/recuring%20expenses.png" />,
  ...
  },
  {
    ...
    icon: TrendingUp,
    visual: <ImagePlaceholder src="/screenshots/cash-flow.png" />,
  ...
  },
  {
    ...
    icon: Store,
    visual: <ImagePlaceholder src="/screenshots/merchant-intelligence.png" />,
  ...
  },
  {
    ...
    icon: HeartPulse,
    visual: <ImagePlaceholder src="/screenshots/financial-health.png" />,
  ...
  },
  {
    ...
    icon: Receipt,
    visual: <ImagePlaceholder src="/screenshots/tax-categorization.png" />,
